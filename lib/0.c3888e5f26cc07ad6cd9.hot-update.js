...
var RList = (0, _mobxReact.observer)(_class = (_class2 = (_temp2 = _class3 = function (_React$Component) {
	...
	_createClass(RList, [{
		...
		key: 'rowsInPart',
		get: function get() {
			console.log(this.containerRef.current.offsetHeight / this.rList.itemHeight, 5667);
			return Math.floor(this.containerRef.current.offsetHeight / this.rList.itemHeight);
		}
	}, {
		key: 'itemsInPart',
		get: function get() {
...
//# sourceMappingURL=0.c3888e5f26cc07ad6cd9.hot-update.js.map