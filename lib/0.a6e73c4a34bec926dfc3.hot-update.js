...
var RList = (0, _mobxReact.observer)(_class = (_class2 = (_temp2 = _class3 = function (_React$Component) {
	...
	_createClass(RList, [{
		...
		value: function renderPart(partNumber) {
			...
			return _react2.default.createElement('div', { className: 'r-list-part-' + partNumber });
		}
	}, {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				this.containerRef.current ? _react2.default.createElement('div', { style: { position: "fixed", bottom: 5, zIndex: "1", right: 5, background: "lightgray", padding: 10 } }) : null,
				_react2.default.createElement(
					'div',
...
//# sourceMappingURL=0.a6e73c4a34bec926dfc3.hot-update.js.map