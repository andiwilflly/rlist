	...
	_createClass(RList, [{
		...
		value: function componentDidMount() {
			...
			_rList2.default.update({
				...
				listScrollTop: window.pageYOffset - this.containerRef.current.offsetTop + this.container.top
			});

			window.addEventListener('scroll', function (event) {
				_rList2.default.update({
					listScrollTop: window.pageYOffset - _this2.containerRef.current.offsetTop + _this2.container.top
				});
			});
...
//# sourceMappingURL=0.09c3d000839052cda6e7.hot-update.js.map