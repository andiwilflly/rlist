...
/******/ 	var hotCurrentHash = "d8ec9f2f316dcb54ca05"; // eslint-disable-line no-unused-vars
	...
	_createClass(RList, [{
		...
		value: function renderParts() {
			...
			return _react2.default.createElement(
				...
				Array.apply(null, new Array(this.partsCount)).map(function (item, partNumber) {
