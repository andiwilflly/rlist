...
/******/ 	var hotCurrentHash = "3e99ba046b0c1b35c823"; // eslint-disable-line no-unused-vars
	...
	_createClass(RList, [{
		...
		value: function componentDidMount() {
			...
			window.addEventListener('scroll', function (event) {
				_rList2.default.update({
					listScrollTop: window.pageYOffset - _this2.containerRef.current.offsetTop
				});
			});
...
// MobX
var RListItem = (0, _mobxReact.observer)(function (props) {
	return _react2.default.createElement(
		'div',
		{ style: {
				display: "inline-block",
				width: _rList2.default.rList.itemWidth,
				height: _rList2.default.rList.itemHeight
			} },
		props.children
	);
});
