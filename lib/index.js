(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["rlistUmd"] = factory();
	else
		root["rlistUmd"] = factory();
})(typeof self !== 'undefined' ? self : this, function() {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	function hotDisposeChunk(chunkId) {
/******/ 		delete installedChunks[chunkId];
/******/ 	}
/******/ 	var parentHotUpdateCallback = window["webpackHotUpdaterlistUmd"];
/******/ 	window["webpackHotUpdaterlistUmd"] = 
...
/******/ 	var hotCurrentHash = "1ffc0f94751065931ed1"; // eslint-disable-line no-unused-vars
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(27), __webpack_require__(28), __webpack_require__(29)(module)))
...
var _RList = __webpack_require__(24);
	...
	_createClass(Test, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					_RList2.default,
					{ scrollable: false, height: 500 },
					this.times(100, function (item, index) {
						return _react2.default.createElement(
							'div',
							{ key: index, className: 'r-list-parts__item', style: {
...
var _rList = __webpack_require__(31);
...
var RList = (0, _mobxReact.observer)(_class = (_class2 = (_temp2 = _class3 = function (_React$Component) {
	...
	function RList() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RList.__proto__ || Object.getPrototypeOf(RList)).call.apply(_ref, [this].concat(args))), _this), _initDefineProp(_this, 'containerWrapperRef', _descriptor, _this), _initDefineProp(_this, 'containerRef', _descriptor2, _this), _initDefineProp(_this, 'itemRef', _descriptor3, _this), _temp), _possibleConstructorReturn(_this, _ret);
	}
	...
	_createClass(RList, [{
		...
		value: function componentDidMount() {
			...
			this.scrollContainer.addEventListener('scroll', function (event) {
				var scrollTop = event.target.scrollTop || window.pageYOffset;
				_rList2.default.update({
					listScrollTop: scrollTop - _this2.containerRef.current.offsetTop
				});
			});
			...
			window.addEventListener('resize', function (event) {
				_rList2.default.update({
					...
					containerWidth: _this2.containerRef.current.offsetWidth
				});
			});
		}
	}, {
		...
		value: function renderPart(partNumber) {
			this.isRenderPart(partNumber) ? this.visibleCurrentPart === partNumber ? console.log('%c renderGamePart \u2116, ' + partNumber, "background: lightblue") : console.log('%c renderGamePart \u2116, ' + partNumber, "background: yellow") : console.log('%c renderGamePart \u2116, ' + partNumber, "background: grey");

			if (!this.isRenderPart(partNumber)) return this.renderPlaceholder();

			return this.gameParts[partNumber].map(function (item, index) {
				return item;
			});
		}
	}, {
		...
		value: function renderParts() {
			...
			return _react2.default.createElement(
				...
				this.times(this.partsCount, function (item, partNumber) {
					return _this3.renderPart(partNumber);
				})
			);
		}
	}, {
		...
		value: function renderPlaceholder() {
			return _react2.default.createElement('div', { className: 'r-list-placeholder', style: {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				!this.containerRef.current ? _react2.default.createElement(
					'div',
					{ className: 'r-list', style: { opacity: 0 } },
					this.fakeItem
				) : null
			);
		}
		...
		key: 'scrollContainer',
		get: function get() {
			return this.props.scrollable ? this.containerWrapperRef.current : window;
		}
	}, {
		key: 'rList',
		get: function get() {
		...
		key: 'itemsInRow',
		get: function get() {
			return Math.floor(this.rList.containerWidth / this.rList.itemWidth);
		}
	}, {
		key: 'widthOfPart',
		get: function get() {
		...
		key: 'itemsInPart',
		get: function get() {
			var itemsInPart = this.rowsInPart * this.itemsInRow;
			return itemsInPart;
		...
		key: 'fakeItem',
		get: function get() {
			return _extends({}, this.items[0], { ref: this.itemRef });
		}
	}]);

	return RList;
}(_react2.default.Component), _class3.displayName = 'RList.component', _class3.propTypes = {
	scrollable: _propTypes.PropTypes.bool,
	height: _propTypes.PropTypes.oneOfType([_propTypes.PropTypes.number, _propTypes.PropTypes.string])
}, _class3.defaultProps = {
	scrollable: false,
	height: 'auto'
}, _temp2), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'containerWrapperRef', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return _react2.default.createRef();
	}
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, 'containerRef', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return _react2.default.createRef();
	}
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, 'itemRef', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return _react2.default.createRef();
	}
}), _applyDecoratedDescriptor(_class2.prototype, 'scrollContainer', [_mobx.computed], Object.getOwnPropertyDescriptor(_class2.prototype, 'scrollContainer'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'rList', [_mobx.computed], Object.getOwnPropertyDescriptor(_class2.prototype, 'rList'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'itemsInRow', [_mobx.computed], Object.getOwnPropertyDescriptor(_class2.prototype, 'itemsInRow'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'widthOfPart', [_mobx.computed], Object.getOwnPropertyDescriptor(_class2.prototype, 'widthOfPart'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'rowsInPart', [_mobx.computed], Object.getOwnPropertyDescriptor(_class2.prototype, 'rowsInPart'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'itemsInPart', [_mobx.computed], Object.getOwnPropertyDescriptor(_class2.prototype, 'itemsInPart'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'heightOfPart', [_mobx.computed], Object.getOwnPropertyDescriptor(_class2.prototype, 'heightOfPart'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'partsCount', [_mobx.computed], Object.getOwnPropertyDescriptor(_class2.prototype, 'partsCount'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'gameParts', [_mobx.computed], Object.getOwnPropertyDescriptor(_class2.prototype, 'gameParts'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'visibleCurrentPart', [_mobx.computed], Object.getOwnPropertyDescriptor(_class2.prototype, 'visibleCurrentPart'), _class2.prototype)), _class2)) || _class;
...
var RListModel = (_class = function () {
	function RListModel() {
		_classCallCheck(this, RListModel);

		_initDefineProp(this, 'rList', _descriptor, this);
	}

	_createClass(RListModel, [{
		key: 'update',
		value: function update(rList) {
	...
	return RListModel;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'rList', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return {
			containerWidth: 0,
...
exports.default = new RListModel();
